...
function flow_comment_fields_placeholders( $fields ) {
    ...
    $fields['author'] = str_replace( 'name="author"', 'placeholder="' . __( 'Name', 'konzept' ) . ( $req ? ' *' : '' ) . '" name="author"', $fields['author'] );
    $fields['email'] = str_replace( 'name="email"', 'placeholder="' . __( 'Email', 'konzept' ) . ( $req ? ' *' : '' ) . '" name="email"', $fields['email'] );
    $fields['url'] = str_replace( 'name="url"', 'placeholder="' . __( 'Website', 'konzept' ) . '" name="url"', $fields['url'] );
...
function flow_comment_textarea_placeholder( $fields ) {
	$fields['comment_field'] = str_replace( 'name="comment"', 'placeholder="' . __( 'Comment', 'konzept' ) . '" name="comment"', $fields['comment_field'] );
