...
get_header(); ?>
	...
	<header class="entry-header">
		...
		<div class="single-meta">
			...
			<?php edit_post_link( __( 'Edit', 'konzept' ), '<span class="edit-link flow-fa flow-fa-pencil">', '</span>' ); ?>
		</div>
	</header>
				...
				<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
					<div class="entry-content">
						...
						<?php
							the_content();
							wp_link_pages( array(
								'before'      => '<div class="page-links"><span class="page-links-title">' . __( 'Pages:', 'konzept' ) . '</span>',
								'after'       => '</div>',
								'link_before' => '<span>',
								'link_after'  => '</span>',
							) );
	...
	<nav class="navigation image-navigation">
		<div class="nav-links">
			<?php previous_image_link( false, '<div class="previous-image">' . __( 'Previous Image', 'konzept' ) . '</div>' ); ?>
			<?php next_image_link( false, '<div class="next-image">' . __( 'Next Image', 'konzept' ) . '</div>' ); ?>
		</div>
	</nav>
